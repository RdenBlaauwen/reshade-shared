...
- legal stuff:
  - Are the elgal disclaimers in the BeanSmoothing module correct?
  - Can I have a MIT license in the same repo as copyrighted material?
- Test if macros can be included more than once, or if it needs include guards
